...
session_start();
/// need db conx
include("../../backend/gateway/Includes/plugin_stats/check_login_status.php");
...
include_once("../../HoodAwards/Includes/db_Conx/index.php");
...
$p_hash = md5 ($p);
		...
		include_once ("../../HoodAwards/gateway/Signup/randStrGen.php");
...
$browserType = substr($user_platform,0,100);
  ...
  VALUES('$u','$e','$p_hash','$currentCountry','$ip',now(),now(),now(),'$currentRegionName', '$currentCity','$browserType','$newRanNum' )";
	...
	$websiteName = "https://www.BlackPeopleMarketplace.com/HoodAwards";
		$to = "$e";							 
		$from = "StreetzWatchin<auto_responder@BlackPeopleMarketplace.com>";
		$subject = 'Black People Marketplace Account Activation';
		$message = '<!DOCTYPE html><html><head><meta charset="UTF-8"><title>StreetzWatchin.com Message</title></head><body style="margin:0px; font-family:Tahoma, Geneva, sans-serif;">
    <p>Hello '.$u.',<br>
      <br>
...
<p>You can also click the link below to activate your account when ready:<br>
      <br>
      <a href="https://www.BlackPeopleMarketplace.com/HoodAwards/gateway/Signup/activation.php?id='.$uid.'&u='.$u.'&e='.$e.'&p='.$p_hash.'">Click here to activate your account now</a><br>
      <br>
      Login after successful activation using your:<br>
    * E-mail Address: <b>'.$e.'</b></p>
  </div><div class="bottom" style="margin:0px; background-color: rgba(229,229,229,1.00); height: 50px; width: 100%; font-size: 12px;   font-family:Tahoma, Geneva, sans-serif; text-align: center; line-height: 120%;">This email was sent by StreetzWatchin.com<br>
