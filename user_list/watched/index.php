...
<title>Hood Awards | watched</title>
...
<div id="page_container">
	<div id="left_side_container">		</div>
				...
				<button id="back_btn" onclick="back_bt_Func();">Back</button>
					...
					<span id="list_title" onclick="">Watched List</span>
...
LEFT JOIN ViewedTable ON  videoInfoTable.videoID=ViewedTable.viewedVideoID WHERE videoInfoTable.videoDeletedBOOL ='NO' and ViewedTable.viewerID = $uID  order by ViewedTable.updateDate desc LIMIT 20 "; 
